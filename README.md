...
## 🏄 Usage
1. **Install the app** on your Android device either from [F-Droid](https://f-droid.org/packages/me.haroldmartin.golwallpaper/), by downloading the latest APK from the [Releases Section](https://github.com/hbmartin/onyx-boox-screensaver-gol/releases/latest) or building from source.
